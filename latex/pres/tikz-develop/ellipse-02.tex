...
\node[ axislabel, left = 10pt ] at (\xmin,0) {$a_1$};
...
\draw[ thin ] (0.23,\ymin) -- ++(0,0.025);
\draw[ thin ] (\xmin,-0.15) -- ++(0.025,0);
% mark ellip[se origin]
\fill (0.23,-0.15) circle (0.0075);
% minimum distance to agreement line
\draw[ thin, gray, opacity=0.3 ] (0.23,-0.15) -- (0.04,0.04);
